...
public class RestoreContext
{
    ...
    public void restore() throws Exception
    {
        ...
        else if (config.isRestoreEncrypted())
        {
            ...
            case GOOGLE:
                scheduler.addTask(GoogleCryptographyRestoreStrategy.JOBNAME, GoogleCryptographyRestoreStrategy.class,
    ...
    enum SourceType
    {
        ...
        public static SourceType lookup(String sourceType, boolean acceptNullOrEmpty, boolean acceptIllegalValue)
                throws UnsupportedTypeException
        {
            if (StringUtils.isEmpty(sourceType))
                ...
                else
                {
                    String message = String
                            .format("%s is not a supported SourceType. Supported values are %s", sourceType,
                                    getSupportedValues());
            ...
            {
                String message = String.format("%s is not a supported SourceType. Supported values are %s", sourceType,
                        getSupportedValues());
