...
public abstract class S3FileSystemBase implements IBackupFileSystem, EventGenerator<BackupEvent>
{
     ...
     */
    protected void postProcessingPerFile(AbstractBackupPath path, long startTimeInMilliSecs,
            long completedTimeInMilliSecs)
    {
        ...
        try
        {
            ...
            BackupUploadRateMeasurement.Metadata metadata = new BackupUploadRateMeasurement.Metadata(path.getFileName(),
                    speedInKBps, elapseTimeInMillisecs);
    ...
    public void upload(AbstractBackupPath path, InputStream in) throws BackupRestoreException
    {
        ...
        postProcessingPerFile(path, TimeUnit.NANOSECONDS.toMillis(startTime),
                TimeUnit.NANOSECONDS.toMillis(completedTime));
        notifyEventSuccess(new BackupEvent(path));
    }

    protected void checkSuccessfulUpload(CompleteMultipartUploadResult resultS3MultiPartUploadComplete,
            AbstractBackupPath path) throws BackupRestoreException
    {
        ...
        else
        {
            ...
            throw new BackupRestoreException(
                    "Error uploading file as ETag or CompleteMultipartUploadResult is NULL -" + path.getFileName());
        }
    }
