...
public class PriamConfiguration implements IConfiguration
{
    ...
    private static final String CONFIG_ROLE_ASSUMPTION_ARN = PRIAM_PRE
    ...
    private final String RAC = SystemUtils
    ...
    private final String LOCAL_HOSTNAME = SystemUtils
            .getDataFromUrl("http://169.254.169.254/latest/meta-data/local-hostname").trim();
    ...
    private final String INSTANCE_ID = SystemUtils.getDataFromUrl("http://169.254.169.254/latest/meta-data/instance-id")
            .trim();
    private final String INSTANCE_TYPE = SystemUtils
            .getDataFromUrl("http://169.254.169.254/latest/meta-data/instance-type").trim();
    // Defaults
