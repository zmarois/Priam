...
public class CassandraAdminTest
{
    ...
    public void parseGossipInfo() throws Exception
    {
        ...
        Assert.assertTrue(
                rootObj.getJSONObject("10.80.147.144").get("SCHEMA").equals("bbb09269-73c9-36a4-b656-13470aa8a3fd"));
        Assert.assertTrue(
                rootObj.getJSONObject("10.75.23.21").get("SCHEMA").equals("bbb09269-73c9-36a4-b656-13470aa8a3fd"));
