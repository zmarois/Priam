...
public class StreamingTest
{
    ...
    public void testAbstractPath()
    {
        ...
        for (int i = 10; i < 30; i++)
        {
            ...
            path.parseRemote("test_backup/" + FakeConfiguration.FAKE_REGION + "/fakecluster/123456/201108" + i + "0000"
                    + "/SNAP/ks1/cf2/f1" + i + ".db");
        ...
        path.parseRemote("test_backup/" + FakeConfiguration.FAKE_REGION
