...
public class TestBackup
{
    ...
    private void testClusterSpecificColumnFamiliesSkipped(String[] columnFamilyDirs) throws Exception
    {
        ...
        for (String columnFamilyDir : columnFamilyDirs)
        {
            ...
            systemfiles.add(String
                    .format("target/data/system/%s/backups/system-%s-ka-1-Data.db", columnFamilyDir, columnFamily));
            systemfiles.add(String
                    .format("target/data/system/%s/backups/system-%s-ka-1-Index.db", columnFamilyDir, columnFamily));
        }
